#!/bin/bash
wget https://hashicorp-releases.yandexcloud.net/nomad/2.0.3/nomad_2.0.3_linux_amd64.zip;
wget https://hashicorp-releases.yandexcloud.net/consul/2.0.3/consul_2.0.3_linux_amd64.zip;
...
#установка nomad
unzip nomad_2.0.3_linux_amd64.zip;
sudo mv nomad /usr/local/bin/;
sudo chmod +x /usr/local/bin/nomad;
#установка nomad
unzip consul_2.0.3_linux_amd64.zip;
